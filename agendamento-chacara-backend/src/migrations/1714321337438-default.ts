...
export class Default1714321337438 implements MigrationInterface {
    name = 'Default1714321337438'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "day-of-schedule_scheduling" ("dayOfSchedule_id" uuid NOT NULL, "scheduling_id" uuid NOT NULL, CONSTRAINT "PK_d926a9fa39b3d595b5467de6d3a" PRIMARY KEY ("dayOfSchedule_id", "scheduling_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "day-of-schedule_scheduling" ADD CONSTRAINT "FK_be5b4010e07b225b1087e4baf1d" FOREIGN KEY ("dayOfSchedule_id") REFERENCES "scheduling"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "day-of-schedule_scheduling" ADD CONSTRAINT "FK_e8ffc4ef8633d1d457cea574744" FOREIGN KEY ("scheduling_id") REFERENCES "day-of-schedule"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
